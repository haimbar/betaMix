...
summary statistics, the fitted mixture model with its threshold, and all
standard diagnostic plots (fitted mixture, degree vs. clustering coefficient,
adjacency bitmap, and a representative cluster network).
