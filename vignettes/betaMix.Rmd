...
summary statistics, a 2×2 goodness-of-fit diagnostic panel (see
`assessFit()` below), and all standard network plots (degree vs. clustering
coefficient, adjacency bitmap, and a representative cluster network).
